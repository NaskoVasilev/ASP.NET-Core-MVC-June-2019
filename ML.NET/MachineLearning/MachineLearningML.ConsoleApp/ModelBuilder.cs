...
namespace MachineLearningML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"F:\Machine Learning\ML.NET\Regression\SofiaPropertiesPricePrediction\imot.bg-2019-07-06.csv";
        private static string MODEL_FILEPATH = @"../../../../MachineLearningML.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.Regression.Trainers.FastTreeTweedie(new FastTreeTweedieTrainer.Options() { NumberOfLeaves = 20, MinimumExampleCountPerLeaf = 10, NumberOfTrees = 500, LearningRate = 0.07684207f, Shrinkage = 1.057825f, LabelColumnName = "Price", FeatureColumnName = "Features" });
